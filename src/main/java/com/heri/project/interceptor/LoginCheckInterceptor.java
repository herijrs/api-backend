package com.heri.project.interceptor;
...
public class LoginCheckInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            loginUserVO.setId((Long) claims.get("id"));
            loginUserVO.setUserName((String) claims.get("userName"));
            loginUserVO.setUserRole((String) claims.get("userRole"));
            loginUserVO.setUserAvatar((String) claims.get("userAvatar"));
